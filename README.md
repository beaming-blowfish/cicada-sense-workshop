...
3. `03-add-cd`: create and initialize the GitOps delivery repository for `cicada-sense`
4. `04-add-cd`: add release preparation and deployment workflows in the application repository
...
3. [03-add-cd.md](03-add-cd.md) - prepare the GitOps delivery repository and scaffold `cicada-sense`
4. [04-add-cd.md](04-add-cd.md) - implement release and deployment workflows